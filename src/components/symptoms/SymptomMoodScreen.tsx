...
export function SymptomMoodScreen() {
  ...
  return (
    ...
    >
      ...
      <div className="flex min-h-0 flex-1 flex-col px-5 pb-8 pt-4">
        <h1
          className="mood-accent-smooth font-display text-center text-xl font-bold leading-snug"
        ...
        <div className="my-6 flex flex-1 flex-col items-center justify-center">
          ...
          <p
            className="mood-accent-smooth font-display mt-6 text-2xl font-bold"
            style={{ color: theme.ink }}
          >
            {theme.label}
          </p>
        ...
        <button
          type="button"
          onClick={() => router.push("/symptoms/log/select")}
