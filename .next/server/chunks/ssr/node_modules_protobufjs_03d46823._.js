 ...
 */ function merge(dst, src, ifNotSet) {
    for(var keys = Object.keys(src), i = 0; i < keys.length; ++i)if (dst[keys[i]] === undefined || !ifNotSet) {
...
"[project]/node_modules/protobufjs/src/util/patterns.js [app-rsc] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
 ...
 */ Service.prototype.create = function create(rpcImpl, requestDelimited, responseDelimited) {
    ...
    for(var i = 0, method; i < /* initializes */ this.methodsArray.length; ++i){
        ...
        rpcService[methodName] = util.codegen([
            "r",
            "c"
        ], reservedRe.test(methodName) ? methodName + "_" : methodName)("return this.rpcCall(m,q,s,r,c)")({
            m: method,
 ...
 */ converter.fromObject = function fromObject(mtype) {
    ...
    var gen = util.codegen([
        "d",
        "n"
    ], mtype.name + "$fromObject")("if(d instanceof this.ctor)")("return d")("if(n===undefined)n=0")("if(n>util.recursionLimit)")("throw Error(\"maximum nesting depth exceeded\")");
...
util.patterns = __turbopack_context__.r("[project]/node_modules/protobufjs/src/util/patterns.js [app-rsc] (ecmascript)");
 ...
 */ util.setProperty = function setProperty(dst, path, value, ifNotSet) {
    function setProp(dst, path, value) {
        var part = path.shift();
        if (unsafePropertyRe.test(part)) return dst;
        if (path.length > 0) {
...
//# sourceMappingURL=node_modules_protobufjs_03d46823._.js.map